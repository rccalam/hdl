...
module up_adc_channel #(
  ...
  parameter   RD_RAW_DATA_ENABLE = 0
) (
  ...
  assign rd_raw_data_enable = (RD_RAW_DATA_ENABLE) ? 1'b1 : 1'b0;
  ...
  always @(posedge up_clk) begin
    if (up_rstn == 0) begin
	  ...
	  4'h2: up_rdata_int <= { rd_raw_data_enable, adc_read_data};
